        ...
        <Grid container spacing={0}>
          ...
          >
            <div>
              <img
                ...
                src={require("../../../assets/icons/parkingServicesIcon1.svg")}
              />
          ...
          >
            <div>
              <img
                className={classes.imgIcon}
                src={require("../../../assets/icons/parkingServicesIcon2.svg")}
              />
          ...
          >
            <div>
              <img
                className={classes.imgIcon}
                src={require("../../../assets/icons/parkingServicesIcon3.svg")}
              />
          ...
          >
            <div>
              <img
                className={classes.imgIcon}
                src={require("../../../assets/icons/parkingServicesIcon4.svg")}
              />
