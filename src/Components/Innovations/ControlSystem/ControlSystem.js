    ...
    >
      <div className={classes.root}>
        ...
        <h1 className={classes.mainTitle}>
          OICCS: Integrated Command Control System
        </h1>
          ...
          <Grid item xs={12} sm={12} md={6} lg={6}>
            ...
            >
              <div>
                <img
                  ...
                  src={require("../../../assets/icons/controlSystemIcon1.svg")}
                />
              </div>
              <div>
            ...
            >
              <div>
                <img
                  className={classes.imgIcon}
                  src={require("../../../assets/icons/controlSystemIcon2.svg")}
                />
              </div>
              <div>
                ...
                <p className={classes.para}>
                  ...
                  <br className={classes.mobileView} />
                  integrated with OICCS and citizen app
                </p>
              </div>
            </div>
            <div
            ...
            >
              <div>
                <img
                  className={classes.imgIcon}
                  src={require("../../../assets/icons/controlSystemIcon3.svg")}
                />
              </div>
              <div>
          ...
          <Grid item xs={12} sm={12} md={6} lg={6}>
            ...
            >
              <div>
                <img
                  className={classes.imgIcon}
                  src={require("../../../assets/icons/controlSystemIcon4.svg")}
                />
              </div>
              <div>
            ...
            >
              <div>
                <img
                  className={classes.imgIcon}
                  src={require("../../../assets/icons/controlSystemIcon5.svg")}
                />
              </div>
              <div>
            ...
            >
              <div>
                <img
                  className={classes.imgIcon}
                  src={require("../../../assets/icons/controlSystemIcon6.svg")}
                />
              </div>
              <div>
