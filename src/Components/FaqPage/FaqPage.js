          ...
          <div className={classes.root1}>
            ...
            <TabPanel className={classes.tabsPanel} value={value} index={0}>
              <div data-aos="fade-left" data-aos-duration="3000">
                ...
                <p className={classes.tabPara}>
                  A Host is someone who has parking space to share. Hosts can
                  list their parking space and accept Guests to share out the
                  parking space.
                </p>
                <br />
                <h4>2. How do I list my parking space?</h4>
                <p className={classes.tabPara}>
                  With the otopark app, you can easily list your available
                  parking space by first taking pictures and describing the
                  parking type, address, and other relevant information that
                  Guests may wish to know. When you create your listing, you
                  decide the duration (hours, daya, etc) available to Guests.
                  After your listing is published, You will get notifications
                  when an interested Guest has booked your listing. You can also
                  manage and edit the listing details right from the app.
                </p>
                <br />
                ...
                <p className={classes.tabPara}>
                  ...
                  Host, you must provide Guests who booked your listing with
                ...
                <p className={classes.tabPara}>
                  ...
                  demand for parking will have higher potential income. If you
                  are in an area with more parking spaces and lower demand, your
                  earning potential may be lower. No matter where you are,
                  otopark makes it easy to list your space and earn money.
                </p>
                <br />
                ...
                <p className={classes.tabPara}>
                  otopark uses a secure payment processor for instant payments.
                  We use a trusted third party payment processor platform to
                  initiate and settle transactions. When a Guest confirms a
            ...
            <TabPanel className={classes.tabsPanel} value={value} index={1}>
              <div data-aos="fade-left" data-aos-duration="3000">
                <div data-aos="fade-left" data-aos-duration="3000">
                  ...
                  <p className={classes.tabPara}>
                    With otopark, Guests can quickly find parking on demand via
                    our mobile app. Guests can find available parking listed by
                    Hosts in real time. Guests choose the required duration
                    offered by the Hosts. Payments are immediately made to
                    ensure the parking space is reserved. You will receive
                    confirmation of the reservation and now can proceed to
                    parking your vehicle in the Host’s parking space.
                  </p>
                  <br />
                  <h4>3. Can I book ahead?</h4>
                  <p className={classes.tabPara}>
                    Yes! In addition to finding on demand parking, otopass also
                    makes it easy to book in advance for a hassle-free
                    experience. Simply browse for the parking listings in the
                    location of interest. Guests can choose the start date and
                    time, along with the duration that the listing will be
                  ...
                  <p className={classes.tabPara}>
                    otopark uses a secure payment processor for instant
                    payments. We use a trusted third party payment processor
                    platform to initiate and settle transactions. Guests pay in
                    advance. The payment will be fully released to the host once
                    the chosen duration for the parking spot has been completed.
                  </p>
                  <br />
                  ...
                  <p className={classes.tabPara}>
                    ...
                    demand. However, otopark will encourage the fair and
                    affordable prices for Hosts to set, in order to bring
                  ...
                  <p className={classes.tabPara}>
                    ...
                    to parking, the Host will share with you the necessary
                    authorization to access the parking. With our app, Hosts can
                    easily share the authorization with otopass to the Guests.
                    The Guest simply shows or activates the otopass to securely
                    enter the closed parking space.
                  </p>
                  <br />
                  <h4>
                  ...
                  <p className={classes.tabPara}>
                    If you encounter disputes with the Host or the parking
                    listing is not as described by the Host, otopass will
                    resolve the situation to set matters straight. The Host will
                    not receive your payments, if applicable, until the
                  ...
                  <p className={classes.tabPara}>
                    ...
                    of departure or arrival. Guests can also apply for
            ...
            <TabPanel className={classes.tabsPanel} value={value} index={2}>
              <div data-aos="fade-left" data-aos-duration="3000">
                ...
                <p className={classes.tabPara}>
                  ...
                  authority will receive payment via otopark app or otopark
                  Ranger app. You will receive payment after the booking has
            ...
            <TabPanel className={classes.tabsPanel} value={value} index={3}>
              <div data-aos="fade-left" data-aos-duration="3000">
                ...
                <p className={classes.tabPara}>
                  Otopark offers professional services ranging from Valet,
            ...
            <TabPanel className={classes.tabsPanel} value={value} index={4}>
              <div data-aos="fade-left" data-aos-duration="3000">
                ...
                <p className={classes.tabPara}>
                  ...
                  ecosystem. With OICCS and Ranger, you can take full advantage
            ...
            <TabPanel className={classes.tabsPanel} value={value} index={5}>
              <div data-aos="fade-left" data-aos-duration="3000">
                ...
                <p className={classes.tabPara}>
                  ...
                  one digital ecosystem. Otopark provides SaaS technologies and
